...
trait DefaultImage{
    ...
    public function storeDefaultImage($path,$name){
        ...
        $fonts = array(
            public_path('admin/fonts/Sukar-Black.otf'),
            public_path('admin/fonts/Sukar-Bold.otf'),
            public_path('admin/fonts/GrifonBlackPersonalUse-BWA7l.otf'),
            public_path('admin/fonts/Sukar-Regular.otf'),
            public_path('admin/fonts/Kahlil-a2b9.woff')
        );
