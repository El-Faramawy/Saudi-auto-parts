    ...
    <div class="card mb-5 mb-xl-8 mt-10">
        ...
        <div class="card-header border-0 pt-5">
            <h3 class="card-title align-items-start flex-column">
                <span class="card-label fw-bolder fs-3 mb-1">الشركات</span>
            </h3>
...
{{--                <a href="{{route('add-company')}}" class="btn btn-light-primary er fs-6 px-7 py-3 ml-2">--}}
...
{{--                        @endif--}}
                    ...
                    @foreach($get as $admin)
                        <tr>
                            ...
                            <td><img class="img" style="width: 50px;height: 50px;border-radius: 50%" src="{{$admin->imagecommercial}} " alt="user" onclick="window.open(this.src)"/></td>
                            <td><img class="img" style="width: 50px;height: 50px;border-radius: 50%" src="{{$admin->imagebank}} " alt="user" onclick="window.open(this.src)"/></td>
                            <td> {{$admin->Commercial_Register}} </td>
                            <td> {{$admin->name}} </td>
                            <td> {{$admin->city}} </td>
                            <td> {{$admin->phone}} </td>
{{--                            <td>--}}
...
{{--                                        <a class="dropdown-item cursor-pointer" href="{{route('company_edit',$admin->id)}}"><i class="fa fa-pen" style="color: #6d6dd5"></i>تعديل</a>--}}
                                        <a class="dropdown-item cursor-pointer delete_element" data_delete="{{route('company_delete')}}" data_id="{{$admin->id}}" ><i class="fa fa-trash"  style="color: #ce031b"></i> حذف</a>
                                    </div>
                                </div>
                            </td>
{{--                            @endif--}}
