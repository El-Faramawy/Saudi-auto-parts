...
{{--                                        <a class="dropdown-item cursor-pointer" href="{{route('user_edit',$admin->id)}}"><i class="fa fa-pen" style="color: #6d6dd5"></i>تعديل</a>--}}
                                        <a class="dropdown-item cursor-pointer delete_element" data_delete="{{route('user_delete')}}" data_id="{{$admin->id}}" ><i class="fa fa-trash"  style="color: #ce031b"></i> حذف</a>
                                    </div>
                                </div>
                            </td>
{{--                            @endif--}}
