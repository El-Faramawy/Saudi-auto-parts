...
<div class="m-grid m-grid--hor m-grid--root m-page">
    <div class="m-grid__item m-grid__item--fluid m-grid m-grid--hor m-login m-login--signin m-login--2 m-login-2--skin-2" id="m_login" style="background-image: url({{url('admin/imgs')}}/bg5.jpg); /*background-position: bottom;*/background-size:100% 100%;">
        <div class="m-grid__item m-grid__item--fluid	m-login__wrapper" style="padding-top: 10px;">
            <div class="m-login__container">
                <div class="m-login__logo">
                    <a href="#">
                        <img src="{{url('admin')}}/imgs/logo.png" width="200px" height="150px" >
                    </a>
                </div>
